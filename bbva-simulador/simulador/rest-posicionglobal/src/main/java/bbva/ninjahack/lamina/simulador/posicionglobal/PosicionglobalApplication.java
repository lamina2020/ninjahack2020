...
@ApplicationPath("/")
@OpenAPIDefinition(
    info = @Info(title = "Posicion global API",
        description = "This API allows CRUD operations on posición global",
        version = "1.0",
...
//    },
    ...
    tags = {
        ...
        @Tag(name = "usuarios", description = "Anybody interested in posicion global")
    }
)
public class PosicionglobalApplication extends Application {
}
// end::adocApplication[]
